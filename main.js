...
// NAMESPACE OBJECT: ./src/showProject.js
var showProject_namespaceObject = {};
__webpack_require__.r(showProject_namespaceObject);
...
const showProject_showProjectF = (element) => {
...
const init = () => {
  ...
  (0,showProject_namespaceObject.default)(defaultProject);
};

const appendToContent = (object) => {
  deletePreviousContent(document.getElementById("main-div"));
  (0,showProject_namespaceObject.default)(
